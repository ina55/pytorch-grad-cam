...
model = models.video.mc3_18(pretrained=True).to(device)
model.eval()
...
for action_name in action_names:
    ...
    if not os.path.exists("output_frames/mc3_18"):
        os.makedirs("output_frames/mc3_18")
    final_output_path = os.path.join("output_frames/mc3_18", final_output_filename)
